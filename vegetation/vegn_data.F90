...
public :: &
    ...
    spdata, &
    min_cosz, &
    agf_bs, K1,K2, tau_lflitter_decomp, tau_cwlitter_decomp, &
...
real, protected :: tau_lflitter_decomp = 0.0 ! e-folding time scale of leaf litter transfer to soil pools in CENTURY mode, yr; 0 means instant transfer
real, protected :: tau_cwlitter_decomp = 0.0 ! e-folding time scale of coarse wood litter transfer to soil pools in CENTURY mode, yr; 0 means instant transfer
