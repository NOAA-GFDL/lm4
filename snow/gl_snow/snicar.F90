...
integer :: snow_shape_defined = 1 ! IF SET TO ZERO, USE ACTUAL VALUE. ELSE, 1-2-3-4 IMPOSE SHAPE
...
integer, parameter :: num_nourbanc = 1 ! EZDEV
  ...
  real, parameter :: snw_rds_refrz   = 1000.0      ! effective radius of re-frozen snow [microns]
