...
use fms_io_mod, only : read_compressed, set_domain, nullify_domain
...
!=================================================================================
  ...
  do i_species = 3,n_river_tracers
     if (id_dis_tr(i_species) > 0) used = &
         send_data (id_dis_tr(i_species), discharge_c(:,:,i_species), lnd%time)
  enddo
