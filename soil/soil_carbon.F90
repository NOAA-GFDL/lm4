...
!   ieee_is_nan(cohort%originalLitterC) .OR. &
!   ieee_is_nan(cohort%livingMicrobeC) .OR. &
!   ieee_is_nan(cohort%CO2)  &
!   )
...
!       (ieee_is_nan(cohort%litterC(n))) .OR. &
!       (ieee_is_nan(cohort%protectedC(n)))  &
!       )
