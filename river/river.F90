...
!#####################################################################
  ...
  subroutine save_river_restart(timestamp)
    ...
    call register_variable_attribute(river_restart, river_res_xdim, "long_name", river_res_xdim, str_len=trim(river_res_xdim))
    ...
    call register_variable_attribute(river_restart, river_res_ydim, "long_name", river_res_ydim, str_len=trim(river_res_ydim))
    ...
    call register_variable_attribute(river_restart, river_res_zdim, "long_name", river_res_zdim, str_len=trim(river_res_zdim))
