...
! ==== public interface ======================================================
public :: tile_diag_base_init
public :: tile_diag_base_end
...
public :: diag_buff_type, tiled_diag_field_type, fields, n_fields
...
public :: send_tile_data, send_tile_data_0d, send_tile_data_1d
...
public :: BASE_TILED_FIELD_ID, BASE_COHORT_FIELD_ID
...
! ==== module constants ======================================================
character(len=*), parameter :: mod_name = 'tile_diag_base_mod'
...
! ============================================================================
subroutine tile_diag_base_init()
