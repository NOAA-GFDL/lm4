...
subroutine add_restart_axis(restart,name,data,is_unstructured,cartesian,units,longname,sense)
  ...
  if (present(cartesian)) then
      call register_variable_attribute(restart%rhandle, name, "cartesian_axis", trim(cartesian), str_len=trim(cartesian))
  endif
  if (present(units)) then
      call register_variable_attribute(restart%rhandle, name, "units", trim(units), str_len=trim(units))
  endif
  if (present(longname)) then
      call register_variable_attribute(restart%rhandle, name, "long_name", trim(longname), str_len=trim(longname))
  endif
...
subroutine create_tile_out_file_idx_new(rhandle,name,tidx,tile_dim_length,zaxis_data,soilCCohort_data)
  ...
  call register_variable_attribute(rhandle, "lon", "units", trim(")degrees_east", str_len=trim("degrees_east"))
  call register_variable_attribute(rhandle, "lon", "long_name", trim(")longitude", str_len=trim("longitude"))
  call register_variable_attribute(rhandle, "lon", "cartesian_axis", trim(")X", str_len=trim("X"))
  ...
  call register_variable_attribute(rhandle, "lat", "units", trim(")degrees_north", str_len=trim("degrees_north"))
  call register_variable_attribute(rhandle, "lat", "long_name", trim(")latitude", str_len=trim("latitude"))
  call register_variable_attribute(rhandle, "lat", "cartesian_axis", trim(")Y", str_len=trim("Y"))
  ...
  call register_variable_attribute(rhandle, "Time", "units", "time trim(level)", str_len=trim("time level"))
  call register_variable_attribute(rhandle, "Time", "long_name", trim(")Time", str_len=trim("Time"))
  call register_variable_attribute(rhandle, "Time", "cartesian_axis", trim(")T", str_len=trim("T"))
