...
character(len=*), parameter :: &
     ...
     version     = '$Id: land_io.F90,v 19.0.4.2 2012/08/29 18:50:11 Zhi.Liang Exp $', &
     tagname     = '$Name: siena_201211 $'

logical :: module_is_initialized = .false.

character(len=64)  :: interp_method = "conservative"
namelist /land_io_nml/ interp_method
...
10   continue
  ...
  if(trim(interp_method) .NE. "conservative" .AND. trim(interp_method) .NE. "conserve_great_circle") then
     call error_mesg ( module_name,'land_io_nml interp_method should be "conservative" or "conserve_great_circle"', FATAL)
  endif
