...
use land_debug_mod, only : check_conservation, water_cons_tol, carbon_cons_tol, &
     heat_cons_tol, do_check_conservation
...
subroutine check_conservation_1(tile,lmass,fmass,cmass,heat)
  type(land_tile_type), intent(in) :: tile
  real, intent(out), optional :: lmass,fmass,cmass,heat ! stocks to check against
